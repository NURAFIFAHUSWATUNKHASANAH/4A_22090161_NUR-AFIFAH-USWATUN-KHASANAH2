    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form method="POST" action="{{ route('lupa-password-act') }}" id="reset-password-form">
                    @csrf
                    <div class="form-group">
                        <label for="email">{{ __('Masukkan Email Yang Terdaftar') }}</label>
                    ...
                    <button type="submit" class="btn btn-primary">{{ __('Kirim Email') }}</button>
                </form>
